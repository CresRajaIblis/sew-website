    ...
    <aside class="w-64 bg-theme-dark text-white flex flex-col justify-between flex-shrink-0 z-20 shadow-xl">
        <div class="p-6">
            ...
            <nav class="space-y-4 pl-2">
                <a href="{{ url('/admin/dashboard') }}" class="flex items-center space-x-4 text-white font-medium hover:text-white transition-all p-2 rounded hover:bg-white/5"><div class="w-6 text-center"><i class="fa-solid fa-table-columns text-lg"></i></div><span>Dashboard</span></a>
